...
def playView(request,song_id):
    ...
    if song_exist==False:
        play_list.append({'song_id':int(song_id),'song_singer':song_info.song_singer,
                          'song_name':song_info.song_name,'song_tiem':song_info.song_time})
        ...
        with open(file,'rb') as f:
            while True:
                ...
                if c:
                    ...
                    break
    #将文件的内容写入StreamingHttpResponse对象，并以字节流的方式返回给用户，实现文件下载
